...
from action_runners.HuggingFace import HuggingFaceZeroShotClassificationAction
...
ACTION_RUNNERS_KIND_MAPPER = {
    ...
    'HuggingFaceZeroShotClassification': HuggingFaceZeroShotClassificationAction
}
